...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4886&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/email_validator-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Installing `email_validator` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
Updating email_validator-feedstock
==================================

If you would like to improve the email_validator recipe or build a new
...
Note that all branches in the conda-forge/email_validator-feedstock are
